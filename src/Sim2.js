    ...
    constructor () {
        ...
        d3.select('#control-text')
            .html('So far, the fish have all been moving randomly on their own. We<br/>\
                ...
                follow its nearest neighbor if it falls within the defined attraction<br/>\
                radius. If There is no fish within this radius, it will move randomly.<br/>\
                ...
                <b>Questions for your exploration</b>: <br/>\
